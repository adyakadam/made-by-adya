export function CartIcon({ size = 22, className }: { size?: number; className?: string }) {
  return (
...
export function HeartIcon({ size = 22, filled = false, className }: { size?: number; filled?: boolean; className?: string }) {
  return (
